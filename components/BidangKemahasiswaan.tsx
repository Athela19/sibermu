...
export default function BidangKemahasiswaan() {
  ...
  return (
    <section
      ...
      className="relative z-20 -mt-6 flex min-h-[100svh] w-full flex-col justify-end overflow-hidden bg-transparent pt-0 will-change-transform lg:-mt-10"
    >
      {/* Dome utama + teks mengikuti alur dome */}
      <div className="relative mx-auto flex min-h-[calc(85svh-10px)] w-[calc(100%-20px)] flex-col items-center justify-end overflow-hidden">
        <svg
